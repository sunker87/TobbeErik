...
//Show Widget
    ...
    if(!empty($div)) {  echo ' '.$div; }; ?>" data-validation-error="<?php echo $validation_message; ?>">
        ...
        <form action="<?php echo $postPermalink; ?>" method="post" class="s2w-form">
            ...
            <label for="s2email"><?php _e('','s2w'); ?></label><br><input type="text" onblur="if (this.value == '') {this.value = 'Enter email address...';}" onfocus="if (this.value == 'Enter email address...') {this.value = '';}" size="20" value="Enter email address..." id="s2email" class="s2w-email" name="email">
